   ...
   /**
    ...
    static public function getDefaultData() {
        return [
            "enabled" => 1,
            "use_php_session" => 0,
            "superuserForceDevelopment" => '',
            "guestForceDevelopmentLocal" => '',
            "forceIsLocal" => '',
            ...
            "forceScream" => '',
            "outputMode" => 'detect',
            "showLocation" => ['Tracy\Dumper::LOCATION_SOURCE', 'Tracy\Dumper::LOCATION_LINK', 'Tracy\Dumper::LOCATION_CLASS'],
            "keysToHide" => 'dbPass, dbName, dbUser, user, username, pass, password, pwd, pw, auth, token, secret',
            "logSeverity" => [],
            "excludedPwLogFiles" => ['session', 'modules', 'file-compiler'],
            "excludedTracyLogFiles" => [],
            "numLogEntries" => 100,
            "numExceptions" => 25,
            "collapse" => 14,
            "collapse_count" => 7,
            ...
            "maxItems" => 100,
            "maxAjaxRows" => 3,
            "showDebugBar" => ['frontend', 'backend'],
            "hideDebugBar" => '',
            "hideDebugBarFrontendTemplates" => [],
            "hideDebugBarBackendTemplates" => [],
            "hideDebugBarModals" => [],
            "frontendPanels" => ['processwireInfo', 'requestInfo', 'processwireLogs', 'tracyLogs', 'tracyExceptions', 'methodsInfo', 'debugMode', 'console', 'panelSelector', 'tracyToggler'],
            "backendPanels" => ['processwireInfo', 'requestInfo', 'processwireLogs', 'tracyLogs', 'tracyExceptions', 'methodsInfo', 'debugMode', 'console', 'panelSelector', 'tracyToggler'],
            "restrictedUserDisabledPanels" => [],
            "nonToggleablePanels" => [],
            "panelSelectorTracyTogglerButton" => 1,
            "showUserBar" => '',
            "showUserBarTracyUsers" => '',
            "userBarFeatures" => ['admin', 'editPage'],
            ...
            "panelZindex" => 100,
            "styleWhere" => ['backend', 'frontend'],
            "styleAdminElements" => "body::before {\n\tcontent: \"[type]\";\n\tbackground: [color];\n\tposition: fixed;\n\tleft: 0;\n\tbottom: 100%;\n\tcolor: #ffffff;\n\twidth: 100vh;\n\tpadding: 0;\n\ttext-align: center;\n\tfont-weight: 600;\n\ttext-transform: uppercase;\n\ttransform: rotate(90deg);\n\ttransform-origin: bottom left;\n\tz-index: 999999;\n\tfont-family: sans-serif;\n\tfont-size: 11px;\n\theight: 13px;\n\tline-height: 13px;\npointer-events: none;\n}\n",
            "styleAdminColors" => "\nlocal|#FF9933\n*.local|#FF9933\ndev.*|#FF9933\n*.test|#FF9933\nstaging.*|#8b0066\n*.com|#009900",
            "styleAdminType" => ['favicon'],
            "showPWInfoPanelIconLabels" => 1,
            "linksNewTab" => '',
            "pWInfoPanelLinksNewTab" => '',
            "customPWInfoPanelLinks" => [11, 16, 22, 21, 29, 30, 31, 304],
            ...
            "requestInfoPanelSections" => ['moduleSettings', 'templateSettings', 'fieldSettings', 'fieldExportCode', 'pageInfo', 'redirectInfo', 'pagePermissions', 'languageInfo', 'templateInfo', 'pageMeta', 'fieldsListValues', 'serverRequest', 'inputGet', 'inputPost', 'inputCookie', 'session', 'editLinks'],
            "processwireInfoPanelSections" => ['versionsList', 'adminLinks', 'documentationLinks', 'gotoId', 'processWireWebsiteSearch'],
            "debugModePanelSections" => ['pagesLoaded', 'modulesLoaded', 'hooks', 'databaseQueries', 'selectorQueries', 'timers', 'user', 'cache', 'autoload'],
            "diagnosticsPanelSections" => ['filesystemFolders'],
            "dumpPanelTabs" => ['debugInfo', 'fullObject'],
            ...
            "userSwitcherRestricted" => [],
            "userSwitcherIncluded" => [],
            ...
            "variablesShowPwObjects" => '',
            "alwaysShowDebugTools" => 1,
            "respectConfigDebugTools" => '',
            "userDevTemplate" => '',
            ...
            "enabledShortcutMethods" => ['addBreakpoint', 'bp', 'barDump', 'bd', 'barDumpBig', 'bdb', 'barEcho', 'be', 'debugAll', 'da', 'dump', 'd', 'dumpBig', 'db', 'l', 'templateVars', 'tv', 'timer', 't']
        ];
    }
    ...
    public function init() {
        ...
        PwVersionSwitcher::cleanupSwitchMarker($this);
    ...
    public function ready() {
        ...
        PwVersionSwitcher::showRevertNotification($this);
