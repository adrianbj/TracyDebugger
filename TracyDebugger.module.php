...
class TracyDebugger extends WireData implements Module, ConfigurableModule {
   ...
   /**
        ...
        if(static::$allowedTracyUser === 'development') {
            ...
            if(Debugger::$showBar) {
                ...
                if($this->showServerTypeIndicator()) {
                    ...
                    if(in_array('favicon', (array)$this->data['styleAdminType'])) Debugger::$customJsStr .= $this->setFaviconBadge();
                }
    ...
    private function setServerAdminStyleColor() {
        ...
        if($serverTypeMatch && isset($stylesArr[$type])) {
            $out = '';
            if(in_array('custom', (array)$this->data['styleAdminType'])) {
                $out .= '
                    <style>
            ...
            if(in_array('default', (array)$this->data['styleAdminType'])) {
                $out .= '
                    <style>
