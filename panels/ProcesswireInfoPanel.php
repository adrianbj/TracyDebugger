...
class ProcesswireInfoPanel extends BasePanel {
    ...
    public function getPanel() {
        ...
        if(in_array('adminLinks', $panelSections)) {
            ...
            <ul class="pw-info-links">
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.$this->wire('config')->urls->admin.'" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                if($this->wire('user')->isLoggedIn()) {
                    ...
                    $out .= '
                    <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                        <a onclick="closePanel()" href="'.\TracyDebugger::inputUrl(true) . (strpos(\TracyDebugger::inputUrl(true), '?') !== false ? '&' : '?') . 'tracyLogout=1" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                    ...
                    $out .= '
                    <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                        <a onclick="closePanel()" href="'.$this->wire('config')->urls->admin . (strpos(\TracyDebugger::inputUrl(true), '?') !== false ? '&' : '?') . 'tracyLogin=1" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.\TracyDebugger::inputUrl(true) . (strpos(\TracyDebugger::inputUrl(true), '?') !== false ? '&' : '?') . 'tracyClearSession=1" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.\TracyDebugger::inputUrl(true) . (strpos(\TracyDebugger::inputUrl(true), '?') !== false ? '&' : '?') . 'tracyModulesRefresh=1" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.$this->wire('config')->urls->admin.'module/edit?name=TracyDebugger" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
        ...
        if(in_array('documentationLinks', $panelSections)) {
            ...
            $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                <a onclick="closePanel()" href="https://github.com/processwire/processwire" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="https://www.processwire.com/talk/" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="https://www.processwire.com/docs/" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="https://processwire.com/api/ref/" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="http://cheatsheet.processwire.com/" '.$this->newTab.' title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
