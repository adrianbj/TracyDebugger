    ...
    public function getPanel() {
        ...
        if(in_array('adminLinks', $panelSections)) {
            ...
            <ul class="pw-info-links">
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.$this->wire('config')->urls->admin.'" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.$this->wire('config')->urls->admin.'module/edit?name=TracyDebugger" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
        ...
        if(count(\TracyDebugger::getDataValue('customPWInfoPanelLinks'))) {
            ...
            foreach(\TracyDebugger::getDataValue('customPWInfoPanelLinks') as $path) {
                ...
                $out .=
                '<li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="'.$cp->url.'"'. (!$withLabels ? ' title="'.$cp->title.'"' : '') . '>
        ...
        if(in_array('documentationLinks', $panelSections)) {
            ...
            $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                <a onclick="closePanel()" href="https://github.com/processwire/processwire" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="https://www.processwire.com/talk/" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="https://www.processwire.com/docs/" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="https://processwire.com/api/ref/" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
                ...
                $out .= '
                <li ' . ($withLabels ? ' class="with-labels"' : '') . '>
                    <a onclick="closePanel()" href="http://cheatsheet.processwire.com/" title="'.(!$withLabels ? ' title="'.$linkTitle.'"' : '').'">
