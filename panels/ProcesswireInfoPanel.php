    ...
    public function getTab() {
        ...
        \Tracy\Debugger::timer('processwireInfo');
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <g>
                <path fill="#ee1d62" d="M11.1,11.8c-0.3,0.2-0.6,0.4-0.8,0.4c-0.4,0.1-0.9,0.2-1.3,0.2c-0.1,0-0.1,0-0.1,0.1l-0.1,0.7
            ...
            return '
            <span title="ProcessWire Page Info & Links">' .
    ...
    public function getPanel() {
        ...
        if(in_array('adminLinks', $panelSections)) {
            ...
            <div class="pw-admin-links" style="text-align: center; border-top:1px solid #CCCCCC; margin-top:10px; padding-top:10px;">
                <a href="'.$this->wire('config')->urls->admin.'" title="PW Admin">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                         viewBox="0 0 20 20.2" enable-background="new 0 0 20 20.2" xml:space="preserve" style="height:16px">
                        <g>
                        <path fill="#ee1d62" d="M11.1,11.8c-0.3,0.2-0.6,0.4-0.8,0.4c-0.4,0.1-0.9,0.2-1.3,0.2c-0.1,0-0.1,0-0.1,0.1l-0.1,0.7
        ...
        if(in_array('documentationLinks', $panelSections)) {
            $out .= '
            <div class="pw-admin-links" style="text-align: center; border-top:1px solid #CCCCCC; margin-top:10px; padding-top:10px;">
                <a href="https://github.com/processwire/processwire" title="Github Repository">
                ...
                <a href="https://www.processwire.com/talk/" title="Support Forum">
                ...
                <a href="https://www.processwire.com/docs/" title="Documentation">
                ...
                <a href="https://processwire.com/api/ref/" title="API Reference">
                ...
                <a href="http://cheatsheet.processwire.com/" title="API Cheatsheet">
