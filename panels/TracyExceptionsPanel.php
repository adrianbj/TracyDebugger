        ...
        foreach($this->filesArray as $file) {
            ...
            if(substr($file, -5) === '.html') {
                ...
                if(file_exists($directory . '/' . $mdFile)) {
                    ...
                    $mdButton = " <button type='button' class='tracy-md-copy-btn' data-md-path='" . htmlspecialchars($mdRelPath, ENT_QUOTES, 'UTF-8') . "' title='Copy this exception as Markdown for an AI agent'><svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' fill='currentColor'><path d='M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z'/></svg></button>";
                }
            }
