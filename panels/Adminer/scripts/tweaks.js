...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelector('.breadcrumbs ul').insertAdjacentHTML('afterbegin', `
        <li class="adminerPwLogo">
            <a href="${window.HttpAdminUrl}" title="Return to PW admin">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <path id="pw_logo_path" d="M94.6,83.7c-0.5-0.7-1.3-1.6-2.1-2.1c-1.7-1.2-3.6-1.6-5.4-1.4c-1.8,0.2-3.3,0.9-4.6,2
