...
class HelloWorldPanel extends BasePanel {
    ...
    protected $icon = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="106.059px" height="106.059px" viewBox="0 0 106.059 106.059" style="enable-background:new 0 0 106.059 106.059;" xml:space="preserve">
        <g>
    ...
    public function getPanel() {
        ...
        $out .= $this->openPanel();
            $out .= $this->label;
        return $this->closePanel($out, $this->name, 'yourSettingsFieldsetId');
    }
