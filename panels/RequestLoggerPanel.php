...
class RequestLoggerPanel extends BasePanel {
    ...
    public function getTab() {
        ...
        $this->icon = '
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 28.477 28.477" style="enable-background:new 0 0 28.477 28.477;" xml:space="preserve">
