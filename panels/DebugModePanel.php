...
class DebugModePanel extends BasePanel {
    ...
    public function getPanel() {
        ...
        ProcessWire Debug Mode" . ($isAdditionalBar ? " (".$isAdditionalBar.") " : " ") . ($debugMode ? 'ON' : 'OFF') . "</h1>" . '<span class="tracy-icons"><span class="resizeIcons"><a href="javascript:void(0)" title="halfscreen" rel="min" onclick="tracyResizePanel(\'DebugModePanel'.($isAdditionalBar ? '-'.$isAdditionalBar : '').'\', \'halfscreen\')">▼</a> <a href="javascript:void(0)" title="fullscreen" rel="max" onclick="tracyResizePanel(\'DebugModePanel'.($isAdditionalBar ? '-'.$isAdditionalBar : '').'\', \'fullscreen\')">▲</a></span></span>' . "
