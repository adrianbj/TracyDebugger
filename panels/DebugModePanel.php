...
class DebugModePanel extends BasePanel {
    ...
    public function getPanel() {
        ...
        ProcessWire Debug Mode" . ($isAdditionalBar ? " (".$isAdditionalBar.") " : " ") . ($debugMode ? 'ON' : 'OFF') . "</h1>" . '<span class="tracy-icons"><span class="resizeIcons"><a href="#" title="Maximize / Restore" data-tracy-resize="DebugModePanel'.($isAdditionalBar ? '-'.$isAdditionalBar : '').'">⛶</a></span></span>' . "
